...
import { CheckCircle, ArrowRight, FileText, Package, Terminal } from 'lucide-react';
...
const ExecutionSteps: React.FC = () => {
    ...
    const generatedSteps: Step[] = [
      {
        ...
        completed: false,
        details: 'Created directories: src, public, components, pages, utils',
      },
      {
        id: 2,
        ...
        completed: false,
        details: 'Added: react, react-dom, react-router-dom, tailwindcss',
      },
      {
        id: 3,
        ...
        icon: <FileText size={18} />,
        completed: false,
        details: 'Created: Navbar.tsx, Button.tsx, Card.tsx, Footer.tsx',
      },
      {
        id: 4,
        ...
        icon: <FileText size={18} />,
        completed: false,
        details: 'Created: HomePage.tsx, AboutPage.tsx, ContactPage.tsx',
      },
      {
        id: 5,
        ...
        icon: <FileText size={18} />,
        completed: false,
        details: 'Set up React Router in App.tsx with routes for all pages',
      },
      {
        id: 6,
        ...
        completed: false,
        details: 'Running build command to generate optimized assets',
      },
    ];
  ...
  return (
    <div className="p-4">
      <h2 className="text-lg font-semibold text-slate-800 dark:text-white mb-4">Execution Steps</h2>
          ...
          >
            ...
            >
              ...
              <div className="flex-shrink-0">
                <ArrowRight 
                  size={16} 
                  className={`transform transition-transform ${step.expanded ? 'rotate-90' : ''} ${
                    step.completed 
                      ? 'text-green-500 dark:text-green-400' 
                      : 'text-slate-400 dark:text-slate-500'
                  }`} 
