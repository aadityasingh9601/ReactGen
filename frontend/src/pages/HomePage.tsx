      ...
      <div className="max-w-3xl w-full space-y-12 text-center">
        <div className="space-y-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white tracking-tight">
            Create beautiful React websites <span className="text-blue-600 dark:text-blue-400">in seconds</span>
          </h1>
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            Describe what you want, and we'll generate a complete React website with all the code you need.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8">
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm">
            ...
            <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white">Fast Generation</h3>
            <p className="text-slate-600 dark:text-slate-300">Get a complete website in seconds, not hours or days.</p>
          </div>
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm">
            ...
            <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white">Production-Ready</h3>
            <p className="text-slate-600 dark:text-slate-300">Clean, well-structured code you can use immediately.</p>
          </div>
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm">
            ...
            <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white">Easily Customizable</h3>
            <p className="text-slate-600 dark:text-slate-300">Edit and extend your generated website as needed.</p>
          </div>
        </div>
      </div>
    </div>
